...
titanic %>% 
   ...
   geom_col(alpha = 0.5, show.legend = FALSE, colour = "black", width = 0.75) + 
   labs(x = NULL, y = NULL, 
...
titanic %>% 
   ...
   ggplot(aes(x = title, y = percent_survived, fill = title)) + 
   geom_col(alpha = 0.5, show.legend = FALSE, colour = "black", width = 0.8) + 
   labs(x = NULL, y = NULL, 
...
titanic %>% 
   ...
   geom_col(alpha = 0.5, show.legend = FALSE, colour = "black", width = 0.7) + 
   labs(x = NULL, y = NULL, 
